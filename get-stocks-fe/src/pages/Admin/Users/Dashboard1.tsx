...
const Dashboard = (props: Props) => {
    ...
    const {
        ...
        queryKey: ['users'],
        queryFn: ({ pageParam }) => {
            return getUsers({ page: pageParam, limit: pageSize });
        },
    ...
    useEffect(() => {
        ...
        if (dataUsers?.pages?.length) {
            const result = dataUsers?.pages?.reduce((acc: any, page: any) => {
    ...
    // console.log('recordsData', recordsData, initialRecords);
    ...
    const fetchDataOnPage = (page: number): void => {
        if (dataUsers?.pages?.length) {
            const pageIsExits = dataUsers?.pages.some((dataPage) => dataPage?.data.page === page);
            if (!pageIsExits) {
    ...
    return (
        <div className="panel">
            <div className="flex md:items-center md:flex-row flex-col mb-5 gap-5">
                <h5 className="font-semibold text-lg dark:text-white-light">Người dùng</h5>
            ...
            <div className="datatables">
                <DataTable
                    ...
                    columns={[
                        {
                            ...
                            sortable: true,
                            render: ({ id }) => {
                                return <div className="text-ellipsis overflow-hidden ... max-w-[50px]">{id}</div>;
                            },
                        },
                        {
                            accessor: 'username',
                        ...
                        { accessor: 'isActive', title: 'Status', sortable: true },
                        {
                            accessor: 'action',
                            title: 'Thao tác',
                            sortable: true,
                                        ...
                                        <Tippy content="Thông tin">
                                            <button type="button">
                                                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <circle opacity="0.5" cx="12" cy="12" r="10" stroke="#000000" strokeWidth="1.5" />
                    ...
                    totalRecords={dataUsers?.pages[0]?.data?.total ? dataUsers.pages[0]?.data?.total : 0}
