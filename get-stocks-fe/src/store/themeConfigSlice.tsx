...
const initialState = {
    ...
    lang: localStorage.getItem('lang') || themeConfig.locale,
    languageList: [
        { code: 'vn', name: 'Vietnamese' },
        { code: 'en', name: 'English' },
        // { code: 'zh', name: 'Chinese' },
...
const themeConfigSlice = createSlice({
    ...
    reducers: {
        ...
        setPageTitle(state, { payload }) {
            // document.title = `${payload}` || 'Get stock system';
        },
    },
});

export const { setLang, toggleTheme, toggleMenu, toggleLayout, toggleRTL, toggleAnimation, toggleNavbar, toggleSemidark, toggleLocale, toggleSidebar, setPageTitle } = themeConfigSlice.actions;
