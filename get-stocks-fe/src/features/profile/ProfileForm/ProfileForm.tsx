...
export const ProfileForm = ({ user, isLoading, isSuccess, mutation }: Props) => {
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <Field
                                    disabled
                                    value={
                                        `${user?.totalDeposit?.toLocaleString('vi-VN', { style: 'currency', currency: 'VND', minimumFractionDigits: 0, maximumFractionDigits: 2 })} - ${
