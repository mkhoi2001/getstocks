                ...
                <div className="overflow-y-auto overflow-x-hidden perfect-scrollbar h-full">
                    ...
                    <div className="border border-dashed border-white-light dark:border-[#1b2e4b] rounded-md mb-3 p-3">
                        ...
                        <div className="grid grid-cols-3 gap-2 mt-3">
                            <button
                                type="button"
                                className={`${themeAdminConfig.menu === 'horizontal' ? 'btn-primary' : 'btn-outline-primary'} btn`}
                    ...
                    <div className="border border-dashed border-white-light dark:border-[#1b2e4b] rounded-md mb-3 p-3">
                        ...
                        <div className="flex gap-2 mt-3">
                            <button
                                type="button"
                                className={`${themeAdminConfig.layout === 'boxed-layout' ? 'btn-primary' : 'btn-outline-primary'} btn flex-auto`}
                            ...
                            <button
                                type="button"
                                className={`${themeAdminConfig.layout === 'full' ? 'btn-primary' : 'btn-outline-primary'} btn flex-auto`}
                    ...
                    <div className="border border-dashed border-white-light dark:border-[#1b2e4b] rounded-md mb-3 p-3">
                        ...
                        <div className="flex gap-2 mt-3">
                            <button type="button" className={`${themeAdminConfig.rtlClass === 'ltr' ? 'btn-primary' : 'btn-outline-primary'} btn flex-auto`} onClick={() => dispatch(toggleRTL('ltr'))}>
                                LTR
                            </button>

                            <button type="button" className={`${themeAdminConfig.rtlClass === 'rtl' ? 'btn-primary' : 'btn-outline-primary'} btn flex-auto`} onClick={() => dispatch(toggleRTL('rtl'))}>
                                RTL
                            </button>
                        </div>
                    </div>
