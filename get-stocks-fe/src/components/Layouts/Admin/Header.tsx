...
import { toggleTheme } from '../../../store/themeAdminConfigSlice';
import { useTranslation } from 'react-i18next';
import { toggleLocale as toggleLocaleAdmin, toggleSidebar } from '../../../store/themeAdminConfigSlice';
...
const Header = () => {
    ...
    const isRtl = useSelector((state: IRootState) => state.themeAdminConfig.rtlClass) === 'rtl' ? true : false;
    ...
    const [flag, setFlag] = useState(themeAdminConfig.locale);

    return (
        <header className={themeAdminConfig.semidark && themeAdminConfig.menu === 'horizontal' ? 'dark' : ''}>
                        ...
                        {/* <div className="dropdown shrink-0">
                            ...
                            >
                                <ul className="!px-2 text-dark dark:text-white-dark grid grid-cols-2 gap-2 font-semibold dark:text-white-light/90 w-[280px]">
                                    {themeAdminConfig.languageList.map((item: any) => {
                                        return (
                                            <li key={item.code}>
                                                <button
                                                    type="button"
                                                    ...
                                                    onClick={() => {
                                                        dispatch(toggleLocaleAdmin(item.code));
                        ...
                        <div className="dropdown shrink-0 flex">
                            ...
                            >
                                <ul className="text-dark dark:text-white-dark !py-0 w-[230px] font-semibold dark:text-white-light/90">
                                    ...
                                    <li>
                                        <Link to={AdminRoutes.PROFILE} className="dark:hover:text-white">
                            ...
                            {menuSidebar?.map((itemSidebar, index) => (
                                <li className="menu nav-item relative" key={index}>
                                    {itemSidebar?.children?.length ? (
                                            ...
                                            <div className="">
                                                <button type="button" className="nav-link">
                                                    <div className="flex items-center">
                                                        ...
                                                        <span className="px-1">{t(itemSidebar.name)}</span>
                                                    </div>
                                        ...
                                        <NavLink to={itemSidebar.path} className="nav-link ">
                                            <div className="flex items-center">
