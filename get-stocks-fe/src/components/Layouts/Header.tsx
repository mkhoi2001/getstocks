...
import { toggleTheme, setLang } from '../../store/themeConfigSlice';
...
const Header = () => {
    ...
    const { mutate: logoutMutation } = useMutation({ mutationFn: logoutApi });
                ...
                <div className="relative bg-white flex w-full items-center px-5 py-2.5 dark:bg-black">
                    <div className="horizontal-logo flex lg:hidden justify-between items-center ltr:mr-2 rtl:ml-2">
                        <Link to="/" className="main-logo flex items-center shrink-0">
                            <img className="w-9 ltr:-ml-1 rtl:-mr-1 inline" src={LogoIcon} alt="logo" />
                    ...
                    <div className="sm:flex-1 ltr:sm:ml-0 ltr:ml-auto sm:rtl:mr-0 rtl:mr-auto flex items-center space-x-1.5 lg:space-x-2 rtl:space-x-reverse dark:text-[#d0d2d6]">
                        ...
                        <div className="flex gap-3">
                            {/* <p className="font-bold">G: {user?.balanceG?.toFixed(2)}</p> */}
                            {/* <p className="font-bold">P: {user?.balanceP?.toFixed(2)}</p> */}
                            ...
                            >
                                <ul className="!px-2 text-dark dark:text-white-dark grid grid-cols-2 gap-2 font-semibold dark:text-white-light/90 w-[280px]">
                                    {themeConfig.languageList.map((item: any) => {
                                        // console.log('i18nv ', i18next.language);
                                        return (
                                            <li key={item.code}>
                                                <button
                                                    type="button"
                        ...
                        <div className="dropdown shrink-0 flex">
                            <p className="text-base mr-1"> {user?.username}</p>
                            <Dropdown
                                offset={[0, 8]}
                                placement={`${isRtl ? 'bottom-start' : 'bottom-end'}`}
                                ...
                                <ul className="text-dark dark:text-white-dark !py-0 w-[230px] font-semibold dark:text-white-light/90">
                                        ...
                                        <div className="flex items-center px-4 py-4">
                                            ...
                                            <div className="ltr:pl-4 rtl:pr-4">
                                                <h4 className="text-base">
                                                    ...
                                                    {user?.firstName ? <span className="text-xs bg-success-light rounded text-success px-1 ltr:ml-2 rtl:ml-2">Pro</span> : ''}
                                                </h4>
                                    ...
                                    <li>
                                        <div className="flex items-center px-4 py-2">
                                            <div className="ltr:pl-4 rtl:pr-4">
                                                {/* <p className="text-base">G: {user?.balanceG?.toFixed(2)}</p> */}
                                                {/* <p className="text-base">P: {user?.balanceP?.toFixed(2)}</p> */}
                                    ...
                                    <li>
                                        <Link to={AppRoutes.PROFILE} className="dark:hover:text-white">
