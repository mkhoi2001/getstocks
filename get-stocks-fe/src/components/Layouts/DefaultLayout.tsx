    ...
    return (
        <App>
            ...
            <div className="relative">
                ...
                {/* ${themeConfig.theme === 'light' ? 'bg-[#EEF0F8]' : ''} */}
                <div className={`${themeConfig.navbar} flex flex-col bg-[#EEF0F8] dark:bg-transparent  main-container text-black dark:text-white-dark min-h-screen`}>
                    {/* BEGIN SIDEBAR */}
                    <Sidebar />
                    {/* END SIDEBAR */}
                    ...
                    <div className="main-content flex-1 flex flex-col">
                        ...
                        {/* END TOP NAVBAR */}
                        <Suspense>
                            <div className={`${themeConfig.animation} flex-1 flex flex-col justify-between p-6 animate__animated`}>
                                {/* {children} */}
                                <Outlet />
